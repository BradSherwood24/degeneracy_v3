...
`3fe3919c5b31bbe9bd258fb7a82f5757a50ee0188b94c6bf0fe1f96f1fcb6aac`); proxy `/health` shows
...
5. **Clean tree + green suite.** `cd pilot && python -m pytest -q` green; the V3.3 params sha:
   ...
   ```
   must print `3fe3919c5b31bbe9bd258fb7a82f5757a50ee0188b94c6bf0fe1f96f1fcb6aac` and equal
