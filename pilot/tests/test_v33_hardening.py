...
def test_params_sha_repinned_and_previous_defined():
    ...
    # BUCKET-FLAP FIX (2026-09-23): re-pinned over the L3 sha (now kept as PREVIOUS_..._L3).
    assert PIN == "3fe3919c5b31bbe9bd258fb7a82f5757a50ee0188b94c6bf0fe1f96f1fcb6aac"
