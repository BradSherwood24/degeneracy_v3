...
| `v33_ladder_ideal.py` / `.out` / `.json` | V3.3 LADDER (Brad 2026-09-22): 1 contract per rung E=5..15c, ideal fills on the spot-bucket tape T-15..T-5, 167 armed windows | 28 pump windows (15 reach E=10); every live set was a full 5->15 sweep; sweeps run to E_max median 22c; 5..15 ladder 1806c vs 155c single-rung x1 (310c at today's 2 lots); first prints 1-2 lots; requires amends (order budget) + new roster |
